...
if (data?.exists) {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      setMsg("تم تسجيلك بنجاح. سيتم تحويلك للصفحة الرئيسية...");
  ...
  return (
    <div style={styles.container}>
      ...
      {step === 1 && (
        <>
          <input style={styles.input} type="text" placeholder="الاسم" value={name} onChange={(e) => setName(e.target.value)} />
...
const styles = {
  container: { fontFamily: "IBMPlexArabic, sans-serif", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", backgroundColor: "#fff" },
  title: { color: "#163853", fontSize: "28px", marginBottom: "20px" },
  input: { width: "300px", padding: "12px", marginBottom: "10px", borderRadius: "8px", border: "1px solid #ccc", fontSize: "16px", color: "#4e4e4e", boxSizing: "border-box" },
